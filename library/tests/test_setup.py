...
def test_odd_zero_burst():
    """Test an odd burst of NUL characters appearing on serial from somewhere.
       This tests the correctness of the code which parses first two bytes of frame header.
    """
    _mock()
    import pms5003
    serial = PMS5003Simulator()
    ...
    serial.simulate_rx(b"\x00\x00\x00\x00\x00")  # odd length is important here
    # This should block until new data is generated by simulator
    data2 = sensor.read()
    data2.pm_ug_per_m3(2.5)
